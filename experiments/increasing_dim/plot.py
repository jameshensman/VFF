...
def plot_KL(d):
    d_full = pd.read_csv('full.csv', index_col=0)
...
plot_pred(pd.read_csv('sparse_opt.csv', index_col=0))
plot_pred(pd.read_csv('sparse_kmeans.csv', index_col=0))
plot_pred(pd.read_csv('kron_opt_gpu.csv', index_col=0))
